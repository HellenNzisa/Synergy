...
import 'package:synergy/helpers/dbhelper.dart';
import 'package:synergy/helpers/mycartmodel.dart';
...
class _MyCartScreenState extends State<MyCartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Shopping MyCart'),
        centerTitle: true,
        actions: [
          Center(
            child: badges.Badge(
              badgeContent: Consumer<MyCartProvider>(
                builder: (context, value , child){
                  return Text(cart.getCounter().toString(),style: TextStyle(color: Colors.white));
                },
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            FutureBuilder(
              future:cart.getData() ,
                builder: (context , AsyncSnapshot<List<MyCart>> snapshot){
                if(snapshot.hasData){
            ...
            Consumer<MyCartProvider>(builder: (context, value, child){
              return Visibility(
                ...
                child: Column(
                  children: [
                    ...
                    ReusableWidget(title: 'Total', value: r'$'+cart.getTotalPrice().toStringAsFixed(2),)
                  ],
                ),
              );
            })
